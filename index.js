...
const h3 = require('h3-js');  // h3-js package is used for H3 indexing
...
app.get('/api/h3', (req, res) => {
    try {
        ...
        // Generate H3 index using the h3-js function.
        // h3.latLngToCell expects three positional arguments: latitude, longitude, and resolution.
        const h3Index = h3.latLngToCell(latitude, longitude, resLevel);
